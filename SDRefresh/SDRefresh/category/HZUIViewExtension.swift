...
extension UIView {
    ...
    var hz_bottomy: CGFloat {
        ...
        get {
            return self.hz_height + self.hz_y
        }
    }

    /// view 右边 X 轴坐标
    var hz_rightx: CGFloat {
        set {
            var frame = self.frame
        ...
        get {
            return self.hz_width + self.hz_x
